...
resource "panos_administrative_tag" "tag" {
  name    = var.tag_name
  comment = "Tag generated by Consul Terraform Sync used for dynamic address group filtering"
  color   = "color38"
  # vsys    = ""
}
...
resource "panos_address_group" "addresses" {
  name          = "Consul Terraform Sync services"
  description   = "Dynamic address group generated by Consul Terraform Sync"
